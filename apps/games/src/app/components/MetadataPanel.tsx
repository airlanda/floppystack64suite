      ...
      <section className="game-meta-panel" onClick={(event) => event.stopPropagation()}>
        <div className="game-meta-header">
          ...
          <div className="game-meta-title-row">
            <div className="game-meta-kicker">Game Search</div>
            <h3>{record?.canonicalTitle || selectedGame.canonicalTitle || record?.gameName || selectedGame.gameName}</h3>
          </div>
        ...
        {!loading && !error ? (
          <div className="game-meta-body">
            ...
            <div className="game-meta-fields">
              ...
              <Field label="Canonical Title" value={record?.canonicalTitle || selectedGame.canonicalTitle || 'Unknown'} />
